...
- [x] Build ComparisonMatrix component (options × criteria, chosen column highlighted, yes/no/partial marks, a11y table, mobile-scroll) + catalog row; broaden catalog-check to match *Matrix components; wire into one-database-two-modes (matrix + accordion pair) @done(2026-07-05T00:00:00Z) #git:pending
