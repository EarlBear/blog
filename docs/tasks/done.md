...
- [x] Add `legend` to the remaining FlowDiagram posts that use special node kinds (from-one-laptop, syncing, what-we-never-collect, pitch-deck) so every diagram with edge/store/external boxes explains them @done(2026-07-04T00:00:00Z) #git:pending
