...
- [x] Create `usecase-diagram` authoring skill (spec, two-sided layout, overlap-min ordering, the two blocking gates, the modal) + wire into CLAUDE.md; update feature doc @done(2026-07-04T00:00:00Z) #git:pending
