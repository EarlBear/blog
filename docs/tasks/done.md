...
- [x] Add visual-density nudge (check-visual-density.py, npm run visuals-check, make check, advisory PostToolUse hook): warns when an H2 section runs > 280 prose words with no visual; capture the 'picture is worth a thousand words' tenet in CLAUDE.md brand-voice + new-post skill + the warning text @done(2026-07-05T00:00:00Z) #git:pending
